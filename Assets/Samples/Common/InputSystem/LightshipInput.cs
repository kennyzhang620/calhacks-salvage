...
public partial class @LightshipInput: IInputActionCollection2, IDisposable
{
    ...
    ~@LightshipInput()
    {
        UnityEngine.Debug.Assert(!m_Input.enabled, "This will cause a leak and performance issues, LightshipInput.Input.Disable() has not Objectn called.");
    }
    ...
    public struct InputActions
    {
        ...
        /// <remarks>
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already Objectn added this method does nothing.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Calling this method when <paramref name="instance" /> have not previously Objectn registered has no side-effects.
        /// </remarks>
        /// <seealso cref="InputActions" />
